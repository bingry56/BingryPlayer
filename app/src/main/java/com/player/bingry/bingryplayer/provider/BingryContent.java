package com.player.bingry.bingryplayer.provider;
...
/**
 * Created by bingry on 2017-05-30.
 */

public class BingryContent {
    ...
    public static final List<BingryItem> ITEMS = new ArrayList<BingryItem>();

    /**
     * A map of sample (dummy) items, by ID.
     */
    public static final Map<String, BingryItem> ITEM_MAP = new HashMap<String, BingryItem>();

    private static final int COUNT = imageThumbUrls.length;

    static {
        // Add some sample items.
        for (int i = 0; i < COUNT; i++) {
            addItem(createBingryItem(i));
        }
    }

    private static void addItem(BingryItem item) {
        ITEMS.add(item);
        ITEM_MAP.put(item.id, item);
    }

    private static BingryItem createBingryItem(int position) {
        return new BingryItem(String.valueOf(position),
                imageThumbUrls[position], imageUrls[position]);
    }
     ...
     */
    public static class BingryItem {
        public final String id;
        public final String content;
        public final String details;

        public BingryItem(String id, String content, String details) {
            this.id = id;
    ...
    public static class VodData {
        ...
        public final String mDateAdded;
        ...
        public VodData(
            ...
            mVideoTitle = title;
            mData = data;
            mVideoSize =  Long.parseLong(size);
            mDateAdded = dateAdded;
            mVideoFilePath = null;
        }
    }

    public static final List<VodData> VOD_ITEMS = new ArrayList<VodData>();
    public static final Map<String, VodData> VOD_ITEM_MAP = new HashMap<String, VodData>();

    public static void addVodItem(VodData item) {
        VOD_ITEMS.add(item);
        VOD_ITEM_MAP.put(item.mData, item);
    }
