...
/**
 * Created by bingry on 2017-06-23.
 */

public class BingryController extends FrameLayout {
...
public interface ControlDispatcher {
    ...
    /**
     * Default {@link BingryController.ControlDispatcher} that dispatches operations to the player without
     * modification.
     */
    public static final BingryController.ControlDispatcher DEFAULT_CONTROL_DISPATCHER = new BingryController.ControlDispatcher() {
    ...
    private final BingryController.ComponentListener componentListener;
    ...
    private BingryController.ControlDispatcher controlDispatcher;
    private BingryController.VisibilityListener visibilityListener;
    ...
    public BingryController(Context context) {
        this(context, null);
    }

    public BingryController(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BingryController(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        int controllerLayoutId = R.layout.controller_view;
        ...
        componentListener = new BingryController.ComponentListener();
    ...
    /**
     * Sets the {@link BingryController.VisibilityListener}.
     *
     * @param listener The listener to be notified about visibility changes.
     */
    public void setVisibilityListener(BingryController.VisibilityListener listener) {
        this.visibilityListener = listener;
    }

    /**
     * Sets the {@link BingryController.ControlDispatcher}.
     *
     * @param controlDispatcher The {@link BingryController.ControlDispatcher}, or null to use
     *     {@link #DEFAULT_CONTROL_DISPATCHER}.
     */
    public void setControlDispatcher(BingryController.ControlDispatcher controlDispatcher) {
